...
export default function DashboardV2() {
  ...
  const sessionUserRole = useMemo(() => {
    return currentUser?.role || "Compliance Manager";
  }, [currentUser]);
      ...
      <div className="flex h-full pt-14">
        ...
        >
          ...
          <div className="flex flex-col gap-1.5 w-full flex-1">
            {sidebarExpanded && (
              <p className="text-[8px] font-bold text-slate-600 uppercase tracking-[0.15em] px-1 mb-1">Navegación</p>
            )}
  ...
  return (
    <div className="group relative w-full">
      <button
        ...
        className={`flex items-center gap-3 w-full py-2.5 rounded-xl transition-all duration-300 cursor-pointer ${
          isActive
